...
--
-- Name: trash trash_item_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trash
    ADD CONSTRAINT trash_item_unique UNIQUE (item_type, item_id);
...
--
-- Name: activity_log_action_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: activity_log_drive_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: activity_log_item_type_item_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: file_metadata_starred_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: key_value_store_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: key_value_store_namespace_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trash_deleted_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trash_deleted_by_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trash_drive_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trash_expires_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: trash_item_type_item_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: file_metadata file_metadata_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: key_value_store key_value_store_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: user_sessions user_sessions_updated_at_trigger; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: activity_log activity_log_drive_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.activity_log
    ADD CONSTRAINT activity_log_drive_id_fkey FOREIGN KEY (drive_id) REFERENCES public.drives(id) ON DELETE CASCADE;
...
--
-- Name: trash trash_deleted_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trash
    ADD CONSTRAINT trash_deleted_by_fkey FOREIGN KEY (deleted_by) REFERENCES public.users(id) ON DELETE RESTRICT;


--
-- Name: trash trash_drive_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trash
    ADD CONSTRAINT trash_drive_id_fkey FOREIGN KEY (drive_id) REFERENCES public.drives(id) ON DELETE CASCADE;
